...
I do not like Git, to the extent that I dislike Linus for having developed it. It is not just that it's solving a hard problem; I believe it is *needlessly* complicated. It has caused more grief for me than arguably any other technology. However, Git is not going away, probably in my lifetime. I need to accept that - learn to stop worrying and love the git. The below is the minimum viable knowledge you have to memorize to say you "know git" to a medium level.
